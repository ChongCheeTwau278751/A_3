...
public class Registration extends JFrame {
	...
	public Registration() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Registration.class.getResource("/A_3/icon.png")));
		...
		lblNewLabel.setBounds(27, 13, 585, 97);
		...
		UsernameLabel.setBounds(101, 163, 184, 72);
		...
		PasswordtextField.setBounds(346, 260, 246, 66);
		...
		ResetButton.setBounds(195, 422, 194, 59);
		...
		LogInButton.setBounds(195, 350, 194, 59);
		contentPane.add(LogInButton);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon(Registration.class.getResource("/A_3/eattttt.png")));
