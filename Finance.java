...
public class Finance extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmFinance.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public Finance() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Finance.class.getResource("/A_3/icon.png")));
		setBounds(100, 100, 596, 505);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		getContentPane().setLayout(null);
		//frmFinance = new JFrame();
		//frmFinance.setTitle("Financial Status and Management");
		//frmFinance.setIconImage(Toolkit.getDefaultToolkit().getImage(Finance.class.getResource("/A_3/icon.png")));
		//frmFinance.setBounds(100, 100, 596, 505);
		//frmFinance.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		//frmFinance.getContentPane().setLayout(null);
		...
		btnRecord.setIcon(new ImageIcon(Finance.class.getResource("/A_3/f5.png")));
		btnRecord.setBounds(205, 339, 164, 70);
		getContentPane().add(btnRecord);
		//frmFinance.getContentPane().add(btnRecord);
		...
		//frmFinance.getContentPane().add(lblNewLabel);
		...
		//frmFinance.getContentPane().add(lblTotalIncomeFor);
		...
		//frmFinance.getContentPane().add(lblTotalSpendingFor);
		...
		button.setIcon(new ImageIcon(Finance.class.getResource("/A_3/e1.png")));
		button.setForeground(Color.WHITE);
		button.setFont(new Font("Times New Roman", Font.BOLD, 14));
		button.setBackground(Color.BLACK);
		button.setBounds(432, 405, 146, 54);
		getContentPane().add(button);
		//frmFinance.getContentPane().add(button);
		...
		//frmFinance.getContentPane().add(textFieldIncome);
		...
		//frmFinance.getContentPane().add(textFieldSpending);
		
		JPanel panel = new JPanel();
		panel.setBackground(new Color(255, 204, 153));
		panel.setBounds(12, 243, 554, 83);
		getContentPane().add(panel);
		//frmFinance.getContentPane().add(panel);
		...
		//frmFinance.getContentPane().add(btnCount);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon(Finance.class.getResource("/A_3/am1.png")));
		lblNewLabel_1.setBounds(0, 0, 578, 459);
		getContentPane().add(lblNewLabel_1);
		//frmFinance.getContentPane().add(lblNewLabel_1);
	}
}
