...
public class RestaurantDescription extends JFrame {
	...
	private JFrame frmRestaurantDescription;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmRestaurantDescription.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public RestaurantDescription() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(RestaurantDescription.class.getResource("/A_3/icon.png")));
		setTitle("Restaurant Description");
		getContentPane().setBackground(new Color(204, 153, 255));
		setBounds(100, 100, 698, 554);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		getContentPane().setLayout(null);
		//frmRestaurantDescription = new JFrame();
		//frmRestaurantDescription.setIconImage(Toolkit.getDefaultToolkit().getImage(RestaurantDescription.class.getResource("/A_3/icon.png")));
		//frmRestaurantDescription.setTitle("Restaurant Description");
		//frmRestaurantDescription.getContentPane().setBackground(new Color(204, 153, 255));
		//frmRestaurantDescription.setBounds(100, 100, 698, 521);
		//frmRestaurantDescription.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		//frmRestaurantDescription.getContentPane().setLayout(null);
		...
		//frmRestaurantDescription.getContentPane().add(lblNewLabel);
		...
		//frmRestaurantDescription.getContentPane().add(btnMoreDetails);
		...
		//frmRestaurantDescription.getContentPane().add(lblNewLabel_2);
		...
		//frmRestaurantDescription.getContentPane().add(lblLocationPulau);
		...
		//frmRestaurantDescription.getContentPane().add(lblContactNumber);
		...
		//frmRestaurantDescription.getContentPane().add(lblMustTryFood);
		...
		//frmRestaurantDescription.getContentPane().add(lblMustTryBeverage);
		...
		btnExit.setIcon(new ImageIcon(RestaurantDescription.class.getResource("/A_3/e1.png")));
		...
		//frmRestaurantDescription.getContentPane().add(lblNewLabel_1);
		
		JButton btnNewButton = new JButton("About our restaurant");
		btnNewButton.setIcon(new ImageIcon(RestaurantDescription.class.getResource("/A_3/ab2.png")));
		...
		//frmRestaurantDescription.getContentPane().add(btnNewButton);
		
		JButton btnMoreDetails = new JButton("More Details");
		btnMoreDetails.setForeground(Color.WHITE);
		btnMoreDetails.setIcon(new ImageIcon(RestaurantDescription.class.getResource("/A_3/dt2.png")));
		...
		//frmRestaurantDescription.getContentPane().add(btnMenuDescription);
		
		JLabel lblNewLabel_4 = new JLabel("New label");
		lblNewLabel_4.setIcon(new ImageIcon(RestaurantDescription.class.getResource("/A_3/rd3.png")));
		lblNewLabel_4.setBounds(0, 0, 680, 507);
		getContentPane().add(lblNewLabel_4);
		//frmRestaurantDescription.getContentPane().add(lblNewLabel_4);
	}
}
