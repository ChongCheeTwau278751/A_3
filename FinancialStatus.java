...
public class FinancialStatus extends JFrame {
	...
	public FinancialStatus() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(FinancialStatus.class.getResource("/A_3/icon.png")));
		...
		btnUpdate.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						try {
						File file = new File("C:\\Users\\User\\Desktop\\Programming I\\EXE2\\src\\A_3\\FinancialManagement.txt");
						if(!file.exists()) {
							file.createNewFile();
							}
		...
		panel.add(btnExit);
		btnExit.setIcon(new ImageIcon(FinancialStatus.class.getResource("/A_3/e1.png")));
