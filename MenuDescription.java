	...
	public MenuDescription() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//
				MenuMWF m1 = new MenuMWF();
				m1.setModalExclusionType(null);
				m1.setVisible(true);
				//
			}
		});
		...
		btnSunday.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null,
						...
						+ "\nDon't forget to rate the best Malaysian Tradisional dishes you think! "
		...
		//frmMenuAndTheme.getContentPane().add(panel_1);
		...
		btnRank.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String dishes = JOptionPane.showInputDialog(null,"The best Malaysian Tadisional Dishes is");
				JOptionPane.showMessageDialog(null, "My top-1 Malaysian Tradisional Dishes is " + dishes);
			}
		});
		...
		JLabel lblNewLabel_6 = new JLabel("Rank my best dishes:");
