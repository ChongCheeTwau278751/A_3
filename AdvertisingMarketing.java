...
public class AdvertisingMarketing extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmAdvertisingAndMarketing.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public AdvertisingMarketing() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(AdvertisingMarketing.class.getResource("/A_3/icon.png")));
		setBounds(100, 100, 720, 589);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		getContentPane().setLayout(null);
		//frmAdvertisingAndMarketing = new JFrame();
		//frmAdvertisingAndMarketing.setTitle("Advertising and Marketing");
		//frmAdvertisingAndMarketing.setIconImage(Toolkit.getDefaultToolkit().getImage(AdvertisingMarketing.class.getResource("/A_3/icon.png")));
		//frmAdvertisingAndMarketing.setBounds(100, 100, 622, 501);
		//frmAdvertisingAndMarketing.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		//frmAdvertisingAndMarketing.getContentPane().setLayout(null);
		...
		lblNewLabel.setBounds(99, -1, 521, 47);
		...
		btnNewButton.setIcon(new ImageIcon(AdvertisingMarketing.class.getResource("/A_3/ig1.png")));
		btnNewButton.setBounds(88, 106, 155, 54);
		...
		lblNewLabel_1.setBounds(127, 48, 443, 16);
		...
		lblC.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 15));
		lblC.setBounds(134, 74, 443, 16);
		...
		btnFacebook.setIcon(new ImageIcon(AdvertisingMarketing.class.getResource("/A_3/fb1.png")));
		btnFacebook.setHorizontalAlignment(SwingConstants.RIGHT);
		btnFacebook.setBounds(265, 106, 155, 54);
		...
		btnTwitter.setIcon(new ImageIcon(AdvertisingMarketing.class.getResource("/A_3/twt1.png")));
		btnTwitter.setHorizontalAlignment(SwingConstants.RIGHT);
		btnTwitter.setBounds(440, 106, 155, 54);
		...
		button.setIcon(new ImageIcon(AdvertisingMarketing.class.getResource("/A_3/e1.png")));
		...
		//frmAdvertisingAndMarketing.getContentPane().add(btnTwitter);
		...
		lblOfficialWebsite.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 15));
		lblOfficialWebsite.setBounds(127, 278, 443, 16);
		getContentPane().add(lblOfficialWebsite);
		//frmAdvertisingAndMarketing.getContentPane().add(lblOfficialWebsite);
		...
		lblOfficialEmailXymaxxgmailcom.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 15));
		lblOfficialEmailXymaxxgmailcom.setBounds(127, 307, 443, 16);
		getContentPane().add(lblOfficialEmailXymaxxgmailcom);
		//frmAdvertisingAndMarketing.getContentPane().add(lblOfficialEmailXymaxxgmailcom);
		...
		lblC_1.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 15));
		lblC_1.setBounds(127, 336, 443, 16);
		getContentPane().add(lblC_1);
		//frmAdvertisingAndMarketing.getContentPane().add(lblC_1);
		...
		lblFaxNumber.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 15));
		lblFaxNumber.setBounds(127, 366, 443, 16);
		getContentPane().add(lblFaxNumber);
		//frmAdvertisingAndMarketing.getContentPane().add(lblFaxNumber);
		...
		lblAnyEnquiriesOr.setBounds(57, 204, 580, 36);
		getContentPane().add(lblAnyEnquiriesOr);
		//frmAdvertisingAndMarketing.getContentPane().add(lblAnyEnquiriesOr);
		...
		lblPleaseContactVia.setBounds(57, 240, 580, 36);
		getContentPane().add(lblPleaseContactVia);
		//frmAdvertisingAndMarketing.getContentPane().add(lblPleaseContactVia);
		...
		lblOnlyReservations.setBounds(57, 379, 580, 36);
		getContentPane().add(lblOnlyReservations);
		//frmAdvertisingAndMarketing.getContentPane().add(lblOnlyReservations);
		...
		label.setBounds(127, 173, 443, 28);
		...
		btnNewButton_1.setIcon(new ImageIcon(AdvertisingMarketing.class.getResource("/A_3/r2.png")));
		btnNewButton_1.setBounds(254, 414, 218, 74);
		getContentPane().add(btnNewButton_1);
		
		JLabel label_1 = new JLabel("New label");
		label_1.setIcon(new ImageIcon(AdvertisingMarketing.class.getResource("/A_3/am4.png")));
		label_1.setBounds(0, 0, 702, 542);
		getContentPane().add(label_1);
		//frmAdvertisingAndMarketing.getContentPane().add(lblNewLabel_2);
	}
}
