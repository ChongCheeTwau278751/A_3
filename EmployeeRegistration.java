...
public class EmployeeRegistration extends JFrame {
	...
	public EmployeeRegistration() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(EmployeeRegistration.class.getResource("/A_3/icon.png")));
		...
		panel.add(btnExit);
		btnExit.setIcon(new ImageIcon(EmployeeRegistration.class.getResource("/A_3/e1.png")));
		...
		btnNewButton_1.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					try {
					File file = new File("C:\\Users\\User\\Desktop\\Programming I\\EXE2\\src\\A_3\\EmployeeRegistration.txt");
					if(!file.exists()) {
						file.createNewFile();
						}
