...
public class ReservationSystem extends JFrame {
	...
	private JFrame frmReservationSystem;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmReservationSystem.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public ReservationSystem() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservationSystem.class.getResource("/A_3/icon.png")));
		setBounds(100, 100, 616, 523);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		getContentPane().setLayout(null);
		//frmReservationSystem = new JFrame();
		//frmReservationSystem.setTitle("Reservation System");
		//frmReservationSystem.setIconImage(Toolkit.getDefaultToolkit().getImage(ReservationSystem.class.getResource("/A_3/icon.png")));
		//frmReservationSystem.setBounds(100, 100, 502, 488);
		//frmReservationSystem.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		//frmReservationSystem.getContentPane().setLayout(null);
		...
		//frmReservationSystem.getContentPane().add(lblNewLabel);
		...
		//frmReservationSystem.getContentPane().add(lblReservationSystem);
		...
		//frmReservationSystem.getContentPane().add(textFieldName);
		...
		btnNewButton.setIcon(new ImageIcon(ReservationSystem.class.getResource("/A_3/d2.png")));
		btnNewButton.setBounds(234, 145, 150, 60);
		getContentPane().add(btnNewButton);
		//frmReservationSystem.getContentPane().add(btnNewButton);
		...
		//frmReservationSystem.getContentPane().add(textFieldCode);
		...
		button.setIcon(new ImageIcon(ReservationSystem.class.getResource("/A_3/e1.png")));
		...
		//frmReservationSystem.getContentPane().add(button);
		...
		//frmReservationSystem.getContentPane().add(lblYourReservationCode);
		...
		//frmReservationSystem.getContentPane().add(lblSnapThisCode);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon(ReservationSystem.class.getResource("/A_3/rs1.png")));
		lblNewLabel_1.setBounds(0, 0, 598, 476);
		getContentPane().add(lblNewLabel_1);
		//frmReservationSystem.getContentPane().add(lblNewLabel_1);
	}
}
